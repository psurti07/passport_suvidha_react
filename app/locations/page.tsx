            ...
            <div className="relative max-w-4xl mx-auto mb-16">
              ...
              <Card className="rounded-3xl border-0 shadow-xl overflow-hidden relative">
                <CardHeader>
                  ...
                  <CardDescription>
                    Enter your PIN code or city to find passport offices near
                    you
                  </CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <Card className="card-hover rounded-3xl border-0 shadow-lg relative bg-white h-full flex flex-col">
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">
                      Delhi Regional Passport Office
                    </CardTitle>
                  ...
                  <CardContent className="space-y-2 flex-grow">
                    ...
                    <div className="mt-2 rounded-lg bg-navy/5 p-2 text-sm">
                      <span className="font-medium text-navy">Note:</span> Prior
              ...
              <div className="group relative grid-rows-1">
                ...
                <Card className="card-hover rounded-3xl border-0 shadow-lg relative bg-white h-full flex flex-col">
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">
                      Mumbai Regional Passport Office
                    </CardTitle>
                    <CardDescription>Regional Passport Office</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-2 flex-grow">
                    ...
                    <div className="mt-2 rounded-lg bg-teal/5 p-2 text-sm">
                      <span className="font-medium text-teal">Note:</span> Prior
                      appointment required
                    </div>
                  </CardContent>
                  <CardFooter className="flex justify-between mt-auto gap-2">
                ...
                <Card className="card-hover rounded-3xl border-0 shadow-lg relative bg-white h-full flex flex-col">
                  ...
                  <CardContent className="space-y-2 flex-grow">
                    ...
                    <div className="mt-2 rounded-lg bg-burgundy/5 p-2 text-sm">
                      <span className="font-medium text-burgundy">Note:</span>{" "}
              ...
              <div className="group relative grid-rows-1">
                ...
                <Card className="card-hover rounded-3xl border-0 shadow-lg relative bg-white h-full flex flex-col">
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">
                      Saligramam Passport Seva Kendra
                    </CardTitle>
                    <CardDescription>Passport Seva Kendra</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-2 flex-grow">
                    ...
                    <div className="mt-2 rounded-lg bg-navy/5 p-2 text-sm">
                      <span className="font-medium text-navy">Services:</span>{" "}
                      New applications, renewals, photos
                    </div>
                  </CardContent>
                  <CardFooter className="flex justify-between mt-auto gap-2">
                    <Button
              ...
              <div className="group relative grid-rows-1">
                ...
                <Card className="card-hover rounded-3xl border-0 shadow-lg relative bg-white h-full flex flex-col">
                  <CardHeader className="pb-2">
                    ...
                    <CardTitle className="text-xl">
                      Ghaziabad Passport Seva Kendra
                    </CardTitle>
                    <CardDescription>Passport Seva Kendra</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-2 flex-grow">
                    ...
                    <div className="mt-2 rounded-lg bg-teal/5 p-2 text-sm">
                      <span className="font-medium text-teal">Services:</span>{" "}
                      New applications, photos available
                    </div>
                  </CardContent>
                  <CardFooter className="flex justify-between mt-auto gap-2">
              ...
              <div className="relative">
                ...
                <Card className="rounded-3xl border-0 shadow-xl overflow-hidden relative">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Choose your passport type and apply online
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Standard processing time with regular fees. Ideal for
                          planned travel and general purposes.
                        </p>
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Expedited processing with higher fees for urgent
