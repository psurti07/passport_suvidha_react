      ...
      >
        <div>
          ...
          <p className="text-muted-foreground">
            Get assistance with your passport applications and account
          </p>
        </div>
      </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-3  gap-6">
              <Card className="md:col-span-2">
                <CardHeader>
                  ...
                  <CardDescription>
                    Fill out the form below to get assistance from our support
                    team
                  </CardDescription>
                </CardHeader>
                  ...
                  >
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <option value="appointment_scheduling">
                ...
                <CardFooter className="border-t p-6">
                  <Button
                    type="submit"
                    form="support-form"
                    className="w-full bg-gradient-to-r from-navy to-teal text-white hover:opacity-90 rounded-xl bg-navy  hover:bg-gradient-to-r/80  rounded-xl modern-button"
                    disabled={isLoading}
                  >
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground mt-1">
                            Send an email to{" "}
                            <a
                              href="mailto:support@passportsuvidha.com"
                              className="text-navy hover:underline"
                            >
                ...
                {!ticketsLoading && !ticketsError && tickets.length > 0 && (
                  <div className="space-y-4">
                    {tickets.map((ticket) => (
                      ...
                      >
                        <CardHeader
                          className={`p-4 ${getHeaderBgClass(ticket.status)}`}
                        >
                          <div className="flex items-start justify-between gap-4">
                            <div>
                              <CardTitle className="text-lg font-medium leading-tight">
                                <Link
                                  href={`/portal/support/tickets/${ticket.ticket_number}`}
