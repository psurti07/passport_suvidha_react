            ...
            <div className="max-w-4xl mx-auto">
              <Card className="rounded-xl border-0 shadow-lg overflow-hidden mb-8">
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    PassportSuvidha is committed to protecting your privacy and
                    ensuring the security of your personal information.
                  </CardDescription>
                </CardHeader>
                <CardContent className="prose prose-slate max-w-none">
                  <p>
                    This Privacy Policy explains how PassportSuvidha ("we,"
                    "us," or "our") collects, uses, shares, and protects
                    personal information obtained from users ("you" or "your")
                    of our website, mobile applications, and services. By using
                    our services, you consent to the data practices described in
                    this policy.
                  </p>
                  <p>
                    We take your privacy seriously and are committed to
                    maintaining the confidentiality and security of your
                    personal information. This policy is designed to help you
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      ...
                      <ul className="space-y-2 pl-7 list-disc">
                        ...
                        <li>
                          Government-issued identification (passport details,
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      ...
                      <ul className="space-y-2 pl-7 list-disc">
                        <li>
                          Performance of a contract when we provide you with
                          services
                        </li>
                        <li>
                          Your consent, where you have given us permission
                        </li>
                        <li>Compliance with legal obligations</li>
                        <li>
                          Our legitimate interests, which do not override your
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      ...
                      <ul className="space-y-2 pl-7 list-disc">
                        <li>
                          Government agencies responsible for passport issuance
                        </li>
                        <li>
                          Service providers who assist us in processing
                          applications
                        </li>
                      ...
                      <p>
                        ...
                        to third parties. We may share anonymized, aggregated
                      ...
                      <p>
                        ...
                        countries may have different data protection laws. When
                        we transfer your information, we implement appropriate
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      <p>
                        ...
                        unauthorized access, accidental loss, alteration, or
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      <p>
                        ...
                        requirements. The retention periods depend on the type
                        of information and the purpose for which it was
                        collected.
                      </p>
                      <p>
                        For passport applications, we typically retain your
                        information for:
                      </p>
                      <ul className="space-y-2 pl-7 list-disc">
                        <li>
                          Completed applications: 7 years from the date of
                          passport issuance
                        </li>
                        <li>
                          Incomplete applications: 1 year from the last activity
                        </li>
                        <li>
                          Account information: As long as your account is
                          active, plus a reasonable period thereafter
                        </li>
                      </ul>
                      <p>
                        When your personal information is no longer required, we
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      ...
                      <ul className="space-y-2 pl-7 list-disc">
                        ...
                        <li>
                          Right to delete your personal information in certain
                          circumstances
                        </li>
                        <li>
                          Right to restrict or object to processing of your
                          personal information
                        </li>
                      ...
                      <p>
                        ...
                        We will respond to your request within the timeframe
              ...
              <div className="mt-10 space-y-6">
                <div className="bg-navy/5 rounded-xl p-6 border border-navy/10">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span>+91-6358292349 (Privacy Office)</span>
                    </div>
                ...
                <div className="bg-teal/5 rounded-xl p-6 border border-teal/10">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    website and updating the "Last Updated" date. We encourage
