    ...
    const getCustomerDetails = async () => {
      try {
        ...
        const passportFormData = {
          ...
          isAddressPermanent: customer.is_address_permanent ?? 1,
          permanentAddress: customer.permanent_address ?? "",
          permanentPinCode: customer.permanent_pin_code ?? "",
          permanentCity: customer.permanent_city ?? "",
          permanentState: customer.permanent_state ?? "",
