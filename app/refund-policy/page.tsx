            ...
            <div className="max-w-4xl mx-auto">
              <Card className="rounded-xl border-0 shadow-lg overflow-hidden mb-8">
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    PassportSuvidha is committed to fair and transparent refund
                    practices for all our services.
                  </CardDescription>
                </CardHeader>
                <CardContent className="prose prose-slate max-w-none">
                  <p>
                    This Refund Policy outlines the terms and conditions under
                    which PassportSuvidha ("we," "us," or "our") will process
                    refunds for passport application services and related fees.
                    We understand that circumstances may arise where you need to
                    cancel your application or service request, and we aim to
                  ...
                  <div className="bg-navy/5 p-4 rounded-lg my-6 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground m-0">
                        ...
                        initial payment. Government fees may not be refundable
                        as they are subject to official policies.
                      </p>
                    </div>
                  </div>
                </CardContent>
              ...
              <Accordion type="single" collapsible className="w-full space-y-4">
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      ...
                      <ul>
                        <li>
                          Unused service fees if cancelled within 24 hours of
                          payment
                        </li>
                        <li>Duplicate payments or overcharges</li>
                        <li>
                          Services not rendered due to technical issues on our
                          part
                        </li>
                        <li>
                          Application fees if the service is discontinued by
                          PassportSuvidha
                        </li>
                      </ul>
                      ...
                      <ul>
                        <li>
                          Government fees once the application is submitted
                        </li>
                        <li>
                          Processing fees after the application review has begun
                        </li>
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      ...
                      <ol>
                        <li>
                          Submit a refund request through your account dashboard
                          or contact support
                        </li>
                        <li>
                          Provide the transaction ID and reason for the refund
                        </li>
                        <li>
                          Our team will review your request within 2-3 business
                          days
                        </li>
                        <li>
                          If approved, refund will be processed to the original
                          payment method
                        </li>
                        <li>
                          Refund may take 5-10 business days to reflect in your
                          account
                        </li>
                      </ol>

                      <p>
                        For expedited refund processing or special
                        circumstances, please contact our customer support team
                        directly.
                      </p>
                    </div>
                  </AccordionContent>
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      <p>Our refund process typically follows these steps:</p>
                      <p>
                        Our company clarify that if we receive chargeback from
                        anywhere like bank and payment Gateway we will contact
                        to the customer and if customer want refund we will
                        provide refund amount to the customer and customer have
                        any other query then we solve customer query.
                      </p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      ...
                      <p>
                        Refunds will be processed back to the original payment
                        method:
                      </p>
                      <ul>
                      ...
                      <p>
                        Note: Bank processing times may vary depending on your
                        financial institution and payment method used.
                      </p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      <p>
                        We may consider refunds under special circumstances:
                      </p>
                      <ul>
                        <li>Medical emergencies (with proper documentation)</li>
                        <li>
                          Natural disasters affecting application processing
                        </li>
                        <li>Service unavailability due to technical issues</li>
                        <li>
                          Changes in government policies affecting eligibility
                        </li>
                      </ul>

                      <p>
                        Each case will be reviewed individually, and decisions
                        will be made based on the provided documentation and
                        circumstances.
                      </p>
                    </div>
                  </AccordionContent>
              ...
              <div className="mt-10 space-y-6">
                <div className="bg-navy/5 rounded-xl p-6 border border-navy/10">
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    request a refund, please contact our support team:
                  </p>
