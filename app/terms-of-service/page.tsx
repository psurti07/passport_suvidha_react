              ...
              <Card className="rounded-xl border-0 shadow-lg overflow-hidden mb-8">
                ...
                <CardContent className="prose prose-slate max-w-none">
                  <p>
                    ...
                    binding agreement between you and PassportSuvidha ("we,"
                    "us," or "our") governing your access to and use of our
                    website, mobile applications, and services (collectively,
                    the "Services").
                  </p>
                  <p>
                  ...
                  <div className="bg-navy/5 p-4 rounded-lg my-6 flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground m-0">
                        Our Services are intended for individuals who are at
                        least 18 years old or accessing the Services under the
                        supervision of a parent or legal guardian. By using our
                        Services, you represent that you meet these
                        requirements.
                      </p>
                    </div>
                  </div>
              ...
              <Accordion type="single" collapsible className="w-full space-y-4">
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      <p>
                        PassportSuvidha provides passport application and
                        renewal services for U.S. citizens. Our Services
                        include:
                      </p>
                      <ul>
                        ...
                        <li>
                          Customer support related to passport applications
                        </li>
                      </ul>
                      <p>
                        We act as an authorized service provider to assist with
                        the passport application process. The actual issuance of
                        passports is the responsibility of the U.S. Department
                        of State.
                      </p>
                    </div>
                  </AccordionContent>
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      ...
                      <p>
                        ...
                        information you provide. Inaccurate information may
                        result in delays or rejection of your passport
                        application by government authorities.
                      </p>
                    </div>
                  </AccordionContent>
                </AccordionItem>
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      <p>
                        Our fee structure consists of government fees for
                        passport issuance and our service fees for processing
                        your application. All fees are clearly displayed before
                      ...
                      <ul>
                        <li>
                          All fees must be paid in full before we process your
                          application
                        </li>
                        <li>
                        ...
                        <li>
                          Prices are subject to change, but changes will not
                      ...
                      <p>
                        Our refund policy varies based on the status of your
                        application:
                      </p>
                      <ul>
                        <li>
                          If we have not yet submitted your application to the
                          government, you may be eligible for a partial refund
                          of our service fees
                        </li>
                        <li>
                          Once your application has been submitted to the
                          government, our service fees are non-refundable
                        </li>
                        <li>
                          Government fees are generally non-refundable, as they
                          are controlled by the U.S. Department of State
                        </li>
                        <li>
                          Expedited service fees are non-refundable once
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      <p>
                        We strive to process all applications promptly, but
                        processing times are estimates and not guarantees.
                      ...
                      <ul>
                        ...
                        <li>
                          Type of service selected (standard or expedited)
                        </li>
                        <li>Unforeseen circumstances or government delays</li>
                      </ul>
                      <p>
                        While we make every effort to meet our estimated
                        processing times, we cannot guarantee passport issuance
                        by a specific date. For time-sensitive travel, we
                        recommend selecting our expedited services and applying
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      <p>
                        To the maximum extent permitted by law, PassportSuvidha
                        shall not be liable for:
                      </p>
                      <ul>
                        <li>
                          Delays or denials of passport applications by
                        ...
                        <li>
                          Issues arising from circumstances beyond our
                          reasonable control
                        </li>
                      </ul>
                      <p>
                        Our total liability for any claims arising from or
                        related to these Terms or our Services shall not exceed
                        the amount you paid to us for the Services giving rise
                        to the claim.
                      </p>
                    </div>
                  </AccordionContent>
                ...
                >
                  ...
                  <AccordionContent className="px-6 pb-4 pt-0">
                    <div className="prose prose-slate max-w-none">
                      <p>
                        All content on our website and Services, including but
                        not limited to text, graphics, logos, icons, images,
                        audio clips, digital downloads, and software, is the
                        property of PassportSuvidha or its content suppliers and
                      ...
                      <p>
                        ...
                        otherwise exploit any portion of our Services, use of
                        our Services, or access to our Services without our
              ...
              <div className="mt-10 space-y-6">
                <div className="bg-navy/5 rounded-xl p-6 border border-navy/10">
                  ...
                  <p className="text-muted-foreground mb-4">
                    ...
                    Services shall be resolved through the following process:
                  </p>
                  <ol className="list-decimal pl-5 space-y-2 text-muted-foreground">
                    <li>
                      Informal Resolution: We encourage you to contact us first
                      to seek an informal resolution.
                    </li>
                    <li>
                      Mediation: If informal resolution is unsuccessful, the
                      parties agree to mediate the dispute before a mutually
                      agreed-upon mediator.
                    </li>
                    <li>
                      Arbitration: If mediation is unsuccessful, the dispute
                      shall be resolved through binding arbitration in
                      Washington, D.C., in accordance with the rules of the
                ...
                <div className="bg-teal/5 rounded-xl p-6 border border-teal/10">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    agree to the modified terms, you should discontinue your use
                    of our Services.
                  </p>
                </div>
                ...
                <div className="bg-burgundy/5 rounded-xl p-6 border border-burgundy/10">
                  ...
                  <p className="text-muted-foreground">
                    ...
                    with the laws of the District of Columbia, without regard to
                    its conflict of law provisions. Your use of our Services may
