          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-5 gap-8 md:gap-12">
            <div className="space-y-4 4 col-span-2 md:col-span-2 lg:col-span-1">
              ...
              <p className="text-sm text-white/70">
                Passport services for Indian citizens. Fast, secure, and
                efficient passport processing throughout India.
              </p>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/70">+91-6358292349</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 break-all">24ABEFB9441P1Z1</p>
                  </div>
                </div>
              </div>
            </div>
